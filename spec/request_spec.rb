...
module VantivLite
  class RequestSpec < Minitest::Spec
    ...
    it 'uses the default config by default' do
      _(Request.new.config).must_equal(VantivLite.default_config)
    end
